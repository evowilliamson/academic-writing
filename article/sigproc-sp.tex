...
\keywords{Context-Oriented Programming, context-aware systems, behavioral variations} 
...
\caption{Layers, behavioral variations, base/partial definition}
\end{figure}
